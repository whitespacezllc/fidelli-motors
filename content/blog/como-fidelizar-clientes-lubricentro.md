...
imagen: /assets/blog/como-fidelizar-clientes-lubricentro.webp
imagenAlt: "Un mecánico y un cliente se dan la mano en el taller."
imagenCredito: "Gustavo Fring · Pexels"
tags: [fidelización, clientes, lubricentro, taller mecánico, WhatsApp]
---
...
1. **Es simple de entender.** "Cada 5 services, el sexto tiene la mano de obra gratis." "Cada 4 cambios, 20% en el siguiente." Si necesita explicación, no funciona.
2. **Se ve.** El cliente tiene que saber que va 3 de 5. Si el conteo lo llevás vos en un cuaderno, para él no existe.
3. **No cambia.** Cambiar las reglas seguido desgasta la confianza más rápido que no tener premio. Definilo una vez y sostenelo un año.
...
*Santiago Afur es cofundador de Fidelli Motors, el sistema de gestión para lubricentros y talleres mecánicos. Cada lunes te muestra a quién le toca volver, con el WhatsApp ya escrito, y tu cliente ve su historial escaneando una calco en el parasol. [Conocé cómo funciona](/).*
